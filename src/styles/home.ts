...
export const introduce: I_Style_Introduce = {
  ...
  leftText: 'col-span-1 absolute top-10 mdn:left-44 left-0 text-4xl font-bold w-64',
  imgItem: 'col-span-1 col-start-2 md:opacity-1 opacity-0',
  rightText: 'col-span-1 absolute top-50 bottom-10 mdn:right-0 w-96',
